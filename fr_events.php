		...
		<div class="row">
			<p>
				<?php if($_SESSION['fr_person_title']=='Administrator')
					echo '<a href="fr_event_create.php" class="btn btn-primary">Add Event</a>';
				?>
				<a href="logout.php" class="btn btn-warning">Logout</a> &nbsp;&nbsp;&nbsp;
				<?php if($_SESSION['fr_person_title']=='Administrator')
					echo '<a href="fr_persons.php" class="btn btn-primary">Customers</a> &nbsp;';
				?>
				<?php if($_SESSION['fr_person_title']=='Administrator')
					echo '<a href="fr_assignments.php" class="btn btn-primary">All Assignments</a>&nbsp;';
				?>
					...
					<?php 
						...
						foreach ($pdo->query($sql) as $row) {
							...
							if ($row['countAssigns']==0)
								...
								echo '<td>'. $row['event_description'] . ' (' . $row['countAssigns']. ' customers)' . '</td>';
							//echo '<td width=250>';
							echo '<td>';
